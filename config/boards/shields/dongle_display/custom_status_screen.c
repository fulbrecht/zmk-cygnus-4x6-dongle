...
// Top Left
    ...
    lv_obj_align_to(zmk_widget_hid_indicators_obj(&hid_indicators_widget), zmk_widget_output_status_obj(&output_status_widget), LV_ALIGN_OUT_TOP_RIGHT, 0, 0);
#endif
...
// Bottom Left
    ...
    lv_obj_align_to(zmk_widget_modifiers_obj(&modifiers_widget), zmk_widget_layer_status_obj(&layer_status_widget), LV_ALIGN_OUT_TOP_RIGHT, 0, 0);
